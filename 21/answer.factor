...
USING: sequences arrays vectors sets regexp splitting ; 
USE: prettyprint
...
: run-program ( program -- program ) [ ip get 28 = ] [ dup run-instruction ] do until ;

"/Users/edd.purcell/projects/aoc2018/21/input.txt" utf8 file-lines unclip
!ip-reg
